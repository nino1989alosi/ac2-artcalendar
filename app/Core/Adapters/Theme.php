...
class Theme extends \App\Core\Theme
{
    ...
    {
        $references = Cache::get('composer.json');
        if (!empty($references)) {
            return $references;
        }
        ...
        Cache::put('composer.json', $references);
     ...
     */
    public static function getNpmPackages()
    {
        $references = Cache::get('package.json');
        if (!empty($references)) {
            return $references;
        }
        ...
        Cache::put('package.json', $references);
