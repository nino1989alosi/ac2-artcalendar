												...
												<div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
													...
													<div class="navi-item my-2">
														<a href="#" class="navi-link">
															<span class="navi-icon mr-4">
																<span class="svg-icon svg-icon-lg">
																	<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Half-star.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													...
													<div class="navi-item my-2">
														<a href="#" class="navi-link">
															<span class="navi-icon mr-4">
																<span class="svg-icon svg-icon-lg">
																	<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Communication/Sending.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																			<rect x="0" y="0" width="24" height="24"></rect>
...
@forelse ($tasks as $row)
    <tr>
        <td><span class="bullet bullet-vertical h-40px" style="color:{{ $row->color}}"></span></td>
        <td>{{ $row->titolo }} </td>
        ...
        <td><label style="background-color:{{ $row->color}}; color:white;font-weight:bold;padding:5px;border-radius:5px;">{{ $row->stato }}</label></td>

        

<td>
        <a href="#" title="MODIFICA" data-id="{{ $row->id }}" class="btn btn-primary btn-udpate-task">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content" style="background-color: #F2F4F4">
                <div class="modal-header bg-dark" style="display: initial;">
                        <span style="float:left;color:white"  id="span-title">Update Task</span>
                </div>
            <div class="modal-body">
                <div class="row">
                <div class="col-md-12">
                        <div class="row">         
                        <input type="text" id="taskId" class="form-control" hidden >    
						<div class="row mb-6">
											<!--begin::Label-->
											<label class="col-lg-4 col-form-label  fw-bold fs-6">{{__('dictionary.stato') }}</label>
											<!--end::Label-->
								...
								<br>
									 ...
									 <div class="row mb-6">
											...
											<!--begin::Col-->
											<div class="col-lg-8 fv-row">
											<select name="scadenza" id="scadenza"  class="form-control form-control-lg form-control-solid">
													<option value=""></option>
								...
								<div class="row"> 
									 ...
									 <div class="row mb-12">
											...
											<!--begin::Col-->
											<div class="col-lg-8 fv-row">
											<textarea id="note" class="form-control form-control-lg form-control-solid" name="note" rows="4" cols="100"></textarea>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" id="closeUpdTask" >Cancella</button>
              <button type="submit" class="btn btn-primary" id="btnupdatetask">
                <span>Salva</span>
              </button>
            </div>
          </div>
