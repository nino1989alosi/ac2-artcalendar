                ...
                <div class="col-md-12">
                        ...
                        <input type="text" id="tId" class="form-control" hidden >             
                                <div class="form-group col-md-12">
                                    <label for="title">{{__('dictionary.priorita') }}</label>
                    ...
                    <div class="col-md-12">
                        <div class="row">                           
                                <div class="form-group col-md-4">
                                    <label for="title">{{__('dictionary.title') }}</label>
                                    <input type="text" id="titolo" class="form-control" >                                  
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="title">{{__('dictionary.descrizione') }}</label>
                                    <input type="text" id="descrizione" class="form-control" >                                  
                               </div>
                                <div class="form-group col-md-4">
                                    <label for="title">{{__('dictionary.utentiassegnati') }}</label>
...
<br>
                <div class="col-md-12">
                        <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="title">{{__('dictionary.scadenza') }}</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="title">{{__('dictionary.gruppiassegnati') }}</label>
                ...
                <div class="col-md-12">
                        <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="title">{{__('dictionary.note') }}</label>
