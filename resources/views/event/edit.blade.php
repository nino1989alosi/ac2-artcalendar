...
<div class="card card-xxl-stretch mb-5 mb-xxl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">{{__('dictionary.editEvent') }}</span>
        </h3>
    ...
    <div class="card-body py-3">
        <div class="tab-content">
									...
									<div class="card-body border-top p-9">
										...
										<div class="row mb-6">
											...
											<div class="col-lg-8 fv-row">
												<input type="text" name="title" required class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.title') }}" value="{{ old('title') ?? $event->title  }}">
											</div>
										</div>
										<!--end::Input group-->
										 ...
										 <div class="row mb-6">
											...
											<!--begin::Col-->
											<div class="col-lg-8 fv-row">
											<textarea id="description" class="form-control form-control-lg form-control-solid" name="descrizione" rows="4" cols="100" value="{{ old('description')  }}">{{ $event->descrizione  }}</textarea>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="row mb-6">
											...
											<div class="col-lg-4 fv-row">
												<input type="date" name="date" required class="form-control form-control-lg form-control-solid" value="{{ $event->date  }}">
                                        ...
                                        <div class="row mb-6" id="etVirtual">
                                            ...
                                            <div class="col-lg-4 fv-row">
												<input type="text" name="locationVirtual"  class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.locationVirtual') }}" value="{{ $event->locationVirtual }}">
											</div>
                ...
                <div class="tab-pane fade" id="kt_table_widget_5_tab_2">
                    <!--begin::Table container-->
                    <div id="kt_account_profile_details" class="collapse show">
                     {{ theme()->getView('event/operator-component', compact('users','groups','element','usersConnected','groupsConnected')) }}
					</div>
                </div>
                <!--end::Tap pane-->
                ...
                <div class="tab-pane fade" id="kt_table_widget_5_tab_3">
                    <!--begin::Table container-->
                    <div id="kt_account_profile_details" class="collapse show">
                     {{ theme()->getView('economy/componentEvent', compact('finantials','element', 'users', 'tags')) }}	
					</div>
                </div>
	            <!-- FINE TAB FINANTIAL -->
                 ...
                 <div class="tab-pane fade" id="kt_table_widget_5_tab_4">
                    <!--begin::Table container-->
                    <div id="kt_account_profile_details" class="collapse show">
                     {{ theme()->getView('partecipante/component', compact('partecipants','element')) }}	
					</div>
                </div>
	            <!-- FINE TAB PARTECIPANTS -->
                 ...
                 <div class="tab-pane fade" id="kt_table_widget_5_tab_5">
                    <!--begin::Table container-->
                    <div id="kt_account_profile_details" class="collapse show">
                     {{ theme()->getView('resource/component', compact('resourcesConnected','element')) }}	
					</div>
                </div>
	            <!-- FINE TAB RESOURCE -->
            ...
            <div class="tab-pane fade" id="kt_table_widget_5_tab_6">
                    <!--begin::Table container-->
                     <div id="kt_account_profile_details" class="collapse show">
                     {{ theme()->getView('document/componentEvent', compact('MyDocuments','documents', 'element')) }}	
                    </div>
                </div>
	                <!-- FINE TAB DOCS -->
             ...
             <div class="tab-pane fade" id="kt_table_widget_5_tab_8">
                    <!--begin::Table container-->
                     <div id="kt_account_profile_details" class="collapse show">
                     {{ theme()->getView('event/note-component', compact('notes', 'element')) }}	
                    </div>
                </div>
	                <!-- FINE TAB DOCS -->
...
var start = '<?php echo $event->startH; ?>';
var end = '<?php echo $event->endH; ?>';
var stato = '<?php echo $event->stato; ?>';
$('#stato').val(stato);
...
var eventType = '<?php echo $event->eventType; ?>';
$('#eventType').val(eventType);

var locationPhisical = '<?php echo $event->locationPhisical; ?>';
var platform = '<?php echo $event->platform; ?>';
