...
<div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <h3><b>{{__('dictionary.manageGroup_Title') }}</b></h3>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-xl-8">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 my-2 my-md-0">
                                    <a href="{{ route('group.new')}}" title="AGGIUNGI" class="btn btn-primary font-weight-bolder btn-go">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4  tab-gen">
                ...
                @forelse ($groups as $c)
                    <tr>
                        ...
                        <a href="{{ route('group_edit', $c->id)}}" title="MODIFICA" class="btn btn-upd btn-table">
