...
<div class="row justify-content-center">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-xl-8">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 my-2 my-md-0">
                                    <a  title="AGGIUNGI" id="openAddDocEvent" href="#" class="btn btn-primary font-weight-bolder btn-go">
        ...
        <!-- NEW -->
<div class="modal fade" id="modalAddDocEvent" role="dialog" aria-hidden="true"> >
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content" style="background-color: #F2F4F4">
                ...
                <form method="POST" action="{{ route('document.saveInEvent') }}" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="eventDocument_id" id="eventDocument_id" value="{{ $element->id }}" hidden>
                        <div class="row mb-12">
                                <!--begin::Label-->
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" id="closeAddDocEvent" >Cancella</button>
...
$( "#openAddDocEvent" ).click(function() {
        $('#modalAddDocEvent').modal('toggle');
      });

      $( "#closeAddDocEvent" ).click(function() {
        $('#modalAddDocEvent').modal('toggle');
      });



      $('body').on('click', '.btndeletedoc', function() {
        $('#mediaIdRemove').text($(this).attr("id"));
        $('#mediaIdRemove').val($(this).attr("id"));
        

        $('#confirmationModalDoc').modal('toggle');
