                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-xl-8">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 my-2 my-md-0">
                                    <a href="{{ route('resource.new')}}" title="AGGIUNGI" class="btn btn-primary font-weight-bolder btn-go">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4  tab-gen">
                ...
                @forelse ($resource as $c)
                    <tr>
                        ...
                        <a href="{{ route('resource_edit', $c->id)}}" title="MODIFICA" class="btn btn-upd btn-table">
