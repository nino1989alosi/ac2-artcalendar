...
<div class="modal fade" id="modalAddEmail" role="dialog" aria-hidden="true"> >
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content" style="background-color: #F2F4F4">
                ...
                <form method="POST" action="{{ route('mediaResource.save') }}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="resourceId" id="resource_id" value="{{ $element->id }}" hidden>
                            <div class="row mb-12">
                                <!--begin::Label-->
       ...
       <div class="modal fade" id="confirmationModalMedia" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" id="btnRemoveCloseMedia"></i> {{__('dictionary.cancel') }}</button>
