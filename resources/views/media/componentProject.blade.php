<div class="row justify-content-center">
        <div class="col-md-12">
            <h3><b>{{__('dictionary.manageMedia_Title') }}</b></h3>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-xl-8">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 my-2 my-md-0">
                                    <a  title="AGGIUNGI" id="openAddEmail" href="#" class="btn btn-primary font-weight-bolder btn-go">
        ...
        <!-- NEW -->
<div class="modal fade" id="modalAddEmail" role="dialog" aria-hidden="true"> >
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content" style="background-color: #F2F4F4">
                ...
                <form method="POST" action="{{ route('mediaProject.save') }}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="projectMediaId" value="{{ $element->id }}" hidden>
                            <div class="row mb-12">
                                <!--begin::Label-->
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" id="closeAddEmail" >Cancella</button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-danger" id="btnRemoveMediaProject"><i class="fa fa-trash mr-1"></i>{{__('dictionary.remove') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
