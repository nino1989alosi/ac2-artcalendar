<x-base-layout>
<div class="row">
<button class="btn btn-light" id="blockedAccount" style="background-color:orangered;color:white;width:20%"> {{__('dictionary.blockedAccount') }} </button>
</div>

<label id="lblBlockAcc" hidden>{{__('dictionary.confirmBlockedAccount') }}</label>
<br>
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{__('dictionary.profileDetails') }}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
            ...
            <div class="card-body border-top p-9">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" name="fullname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="{{__('dictionary.fullname') }}" value="{{ old('fullname') ?? $profile->fullname }}">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="nickname" class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.nickname') }}" value="{{ old('nickname') ?? $profile->nickname }}">
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{__('dictionary.birth_date') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                    <input type="date" name="birth_date" class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.birth_date') }}" value="{{ old('birth_date') ?? $profile->birth_date }}">
                ...
                <!--end::Input group-->
                 ...
                 <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{__('dictionary.birth_city') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="birth_country" class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.birth_country') }}" value="{{ old('birth_country') ?? $profile->birth_country }}">
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                 ...
                 <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{__('dictionary.gender') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                    <select name="gender" id="gender" class="form-control form-control-lg form-control-solid">
                            <option value="">{{__('dictionary.selectgender') }}</option>
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{__('dictionary.company') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.company') }}" value="{{ old('company') ?? $profile->company }}">
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">{{__('dictionary.phone') }} </span>

                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="{{__('dictionary.phoneMustActive') }}" aria-label="{{__('dictionary.phoneMustActive') }}"></i>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="tel" name="phone" class="form-control form-control-lg form-control-solid" placeholder="{{__('dictionary.phone') }}" value="{{ old('phone') ?? $profile->phone }}">
                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">{{__('dictionary.country') }}</span>

                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="{{__('dictionary.country') }}" aria-label="{{__('dictionary.country') }}"></i>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="country" id="country" aria-label="{{__('dictionary.countryDefault') }}" data-control="select2" data-placeholder="{{__('dictionary.countryDefault') }}..." class="form-select form-select-solid form-select-lg fw-bold select2-hidden-accessible" data-select2-id="select2-data-7-l0k8" tabindex="-1" aria-hidden="true">
                            <option value="" data-select2-id="select2-data-9-vnjf">{{__('dictionary.countryDefault') }}...</option>
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label required fw-bold fs-6">{{__('dictionary.language') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <!--begin::Input-->
                        <select name="language" id="language" aria-label="{{__('dictionary.languageDefault') }}..." data-control="select2" data-placeholder="{{__('dictionary.languageDefault') }}..." class="form-select form-select-solid form-select-lg select2-hidden-accessible" data-select2-id="select2-data-10-xkms" tabindex="-1" aria-hidden="true">
                            <option value="" data-select2-id="select2-data-12-20w2">{{__('dictionary.languageDefault') }}...</option>
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label required fw-bold fs-6">{{__('dictionary.timezone') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="timezone" id="timezone" aria-label="{{__('dictionary.timezoneDefault') }}" data-control="select2" data-placeholder="{{__('dictionary.timezoneDefault') }}.." class="form-select form-select-solid form-select-lg select2-hidden-accessible" data-select2-id="select2-data-13-51f9" tabindex="-1" aria-hidden="true">
                            <option value="" data-select2-id="select2-data-15-ejqj">{{__('dictionary.timezoneDefault') }}..</option>
...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_signin_method">
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0"> {{__('dictionary.signInMet') }}</h3>
        </div>
    </div>
    <!--end::Card header-->
        ...
        <div class="card-body border-top p-9">
            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                <div id="kt_signin_email">
                    <div class="fs-6 fw-bolder mb-1"> {{__('dictionary.email') }}</div>
            ...
            <div class="d-flex flex-wrap align-items-center mb-10">
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    <!--begin::Form-->
                    <form id="kt_signin_change_password" method="POST" action="{{ route('myprofile.changepwd') }}" 
                class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" >
                    @csrf
                       <input type="hidden" name="current_email" value="{{$profile->email}}">
                        <div class="row mb-1">
                            

                            <div class="col-lg-4">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label for="password" class="form-label fs-6 fw-bolder mb-3">{{__('dictionary.newPwd') }}</label>
                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label for="password_confirmation" class="form-label fs-6 fw-bolder mb-3">{{__('dictionary.confirmnewPwd') }}</label>
                        ...
                        <div class="form-text mb-5">{{__('dictionary.rightPwd') }}</div>

                        <div class="d-flex">
                            <button id="kt_password_submit" type="submit" class="btn btn-primary me-2 px-6">
                                <!--begin::Indicator-->
                                <span class="indicator-label">
                                {{__('dictionary.updatePwd') }}
                                </span>
                                <span class="indicator-progress">
                                {{__('dictionary.waiting') }}
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                            ...
                            <button id="kt_password_cancel" type="button" class="btn btn-color-gray-400 btn-active-light-primary px-6">{{__('dictionary.cancel') }} </button>
                        </div>
                    <div></div></form>
                    <!--end::Form-->
                </div>
                ...
                <div id="kt_signin_password_button" class="ms-auto">
                    <button class="btn btn-light btn-active-light-primary"> {{__('dictionary.resetPwd') }} </button>
                </div>
                <!--end::Action-->
            </div>
            <!--end::Password-->
...
<script>
 $( document ).ready(function() {
     ...
     var text = $('#lblBlockAcc').text();
        var timezone = '<?php echo $profile->timezone; ?>';
        var country = '<?php echo $profile->country; ?>';
        var language = '<?php echo $profile->language; ?>';
        var gender = '<?php echo $profile->gender; ?>';

        $("#gender option[value='" + gender + "']").attr("selected", "selected");

        if(timezone != ""){
            $('#timezone').val(timezone).trigger('change');       
            $("#select2-timezone-container span").text($( "#timezone option:selected" ).text());
        }
        if(country != ""){
            $('#country').val(country).trigger('change');       
            $("#select2-country-container span").text($( "#country option:selected" ).text());
        }

        if(language != ""){
            $('#language').val(language).trigger('change');       
            $("#select2-language-container span").text($( "#language option:selected" ).text());
        }
...
$('#kt_signin_password_button button').click(function() {
    ...
    $('#kt_signin_password_button button').hide();
  ...
  $('#blockedAccount').click(function() {

    var r = confirm(text);
    if (r == true) {
        

            jQuery.ajax('/myprofile_blocked',
            {
                method: 'POST',
                data: {
